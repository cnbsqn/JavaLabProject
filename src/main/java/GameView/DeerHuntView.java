...
public class DeerHuntView implements StrategyGamesView {
	...
	public DeerHuntView(JButton[] gamesButtons, String[] GamesButtonsLabels, JPanel gamesButtonsPanel) {
		gamesButtons = new JButton[2];
		GamesButtonsLabels = new String[2];
		GamesButtonsLabels[0] = "Deer";
		GamesButtonsLabels[1] = "Hare";
		numberOfButtons = 2;
